...
public class AddRecordFragment extends Fragment {
        ...
        switch (requestCode) {
            case FILE_SELECT_CODE:
                if (resultCode == RESULT_OK) {
                    ...
                    // Initiate the upload
                    new addRecord(uri).execute(path, uri.getEncodedPath(), title.getText().toString(), desc.getText().toString());
                }
                break;
        }
    }
    ...
    private class addRecord extends AsyncTask<String, String, String> {
        Uri ur;

        public addRecord(Uri uri) {
            ur = uri;
        }
        @Override
            ...
            riversRef.putFile(file)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Post post = new Record(strings[2], strings[3], downloadUrl.toString());
